...
function displayWeather1(data1) {
    //First day
    var temperature1 = document.getElementById('temperature1').innerHTML = `${Math.round((data1.daily[0].temp.max))}/${Math.round((data1.daily[0].temp.min))}°C`;
    ...
    var humidity1 = document.getElementById('humidity1').innerHTML = `${data1.daily[0].humidity}%`;
    var weatherIcon1 = document.getElementById('weatherIcon1').src = 'https://openweathermap.org/img/wn/' +
    data1.daily[0].weather[0].icon +
    '@4x.png';

    //Second Day
    var temperature2 = document.getElementById('temperature2').innerHTML = `${Math.round((data1.daily[1].temp.max))}/${Math.round((data1.daily[1].temp.min))}°C`;
    ...
    var humidity2 = document.getElementById('humidity2').innerHTML = `${data1.daily[1].humidity}%`;
    var weatherIcon2 = document.getElementById('weatherIcon2').src = 'https://openweathermap.org/img/wn/' +
    data1.daily[1].weather[0].icon +
    '@4x.png';

    //Third Day
    var temperature3 = document.getElementById('temperature3').innerHTML = `${Math.round((data1.daily[2].temp.max))}/${Math.round((data1.daily[2].temp.min))}°C`;
    ...
    var humidity3 = document.getElementById('humidity3').innerHTML = `${data1.daily[2].humidity}%`;
    var weatherIcon3 = document.getElementById('weatherIcon3').src = 'https://openweathermap.org/img/wn/' +
    data1.daily[2].weather[0].icon +
    '@4x.png';

    //Fourth Day
    var temperature4 = document.getElementById('temperature4').innerHTML = `${Math.round((data1.daily[3].temp.max))}/${Math.round((data1.daily[3].temp.min))}°C`;
    ...
    var humidity4 = document.getElementById('humidity4').innerHTML = `${data1.daily[3].humidity}%`;
    var weatherIcon4 = document.getElementById('weatherIcon4').src = 'https://openweathermap.org/img/wn/' +
    data1.daily[3].weather[0].icon +
    '@4x.png';

    //Fifth Day
    var temperature5 = document.getElementById('temperature5').innerHTML = `${Math.round((data1.daily[4].temp.max))}/${Math.round((data1.daily[4].temp.min))}°C`;
    ...
    var humidity5 = document.getElementById('humidity5').innerHTML = `${data1.daily[4].humidity}%`;
    var weatherIcon5 = document.getElementById('weatherIcon5').src = 'https://openweathermap.org/img/wn/' +
    data1.daily[4].weather[0].icon +
    '@4x.png';

    //Sixth Day 
    var temperature6 = document.getElementById('temperature6').innerHTML = `${Math.round((data1.daily[5].temp.max))}/${Math.round((data1.daily[5].temp.min))}°C`;
    ...
    var humidity6 = document.getElementById('humidity6').innerHTML = `${data1.daily[5].humidity}%`;
    var weatherIcon6 = document.getElementById('weatherIcon6').src = 'https://openweathermap.org/img/wn/' +
    data1.daily[5].weather[0].icon +
    '@4x.png';

    //Seventh Day
    var temperature7 = document.getElementById('temperature7').innerHTML = `${Math.round((data1.daily[6].temp.max))}/${Math.round((data1.daily[6].temp.min))}°C`;
    ...
    var humidity7 = document.getElementById('humidity7').innerHTML = `${data1.daily[6].humidity}%`;
    var weatherIcon7 = document.getElementById('weatherIcon7').src = 'https://openweathermap.org/img/wn/' +
    data1.daily[6].weather[0].icon +
    '@4x.png';

    //Eigth Day
    var temperature8 = document.getElementById('temperature8').innerHTML = `${Math.round((data1.daily[7].temp.max))}/${Math.round((data1.daily[7].temp.min))}°C`;
    ...
    var humidity8 = document.getElementById('humidity8').innerHTML = `${data1.daily[7].humidity}%`;
