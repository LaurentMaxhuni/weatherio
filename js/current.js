...
function successFunction(position) {
    ...
    fetch(url1).then(response => response.json()).then(data => displayWeather(data)).catch(error => console.error('Error fetching data: ' + error));
}
...
function getWeather() {
    ...
    fetch(url).then(response => response.json()).then(data => displayWeather(data)).catch(error => console.error('Error fetching data: ' + error));
}
